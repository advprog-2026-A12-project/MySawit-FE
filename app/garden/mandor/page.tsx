...
export default function MandorGardenPage() {
		...
		<main className="min-h-screen bg-green-50 p-6 md:p-8">
			<div className="mx-auto max-w-6xl space-y-6">
				<header className={cardCls}>
					<h1 className="text-2xl font-bold text-green-900 md:text-3xl">Dashboard Mandor - Kebun Tugas</h1>
					<p className="mt-1 text-sm text-green-700 md:text-base">Pantau kebun yang ditugaskan dan daftar supir.</p>
				</header>
							...
							<div className="mt-4 overflow-x-auto">
								<table className="min-w-full divide-y divide-green-100">
									<thead className="bg-green-50">
										<tr>
											{["Nama", "Kode", "Luas (Ha)", "Supir", "Status"].map((h) => (
						...
						<div className={cardCls}>
							...
							{selectedId && detail && (
								<div className="mt-4 space-y-4">
									...
									<div className="rounded-xl border border-green-100 bg-green-50/40 p-4">
										<h3 className="text-sm font-semibold text-green-800">Daftar Supir ({detail.totalSupir ?? 0})</h3>
